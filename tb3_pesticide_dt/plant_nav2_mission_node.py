#!/usr/bin/env python3
"""Nav2 action-based plant inspection mission for the pesticide DT demo."""
    ...
    def finish_inspection(self, result: Dict):
        ...
        if entry["status"] == "OVERUSE":
            ...
            self.get_logger().warn(
                f"{zone.zone_id} classified as OVERUSE. Holding {hold_s:.1f}s before next goal."
            )
        else:
